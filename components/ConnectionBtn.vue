<template>
  ...
  >
    <template v-slot:activator="{ on, attrs }">
      <div class="flex flex-col align-center md:flex md:flex-row justify-end md:mt-[px] md:mr-[24px] gap-[16px]">
        <div class="mt-15">
        ...
        <div class="mt-15" v-if="!isLoggIn">
          <v-btn          
            ...
            v-bind="attrs"
            v-on="on"
            class="bg-[#00C6ED] rounded-[14px] w-[188px] md:w-[204px] h-[40px] token-button"
    ...
    <v-card class="bg-[#17171B] rounded-[16px]">      
      ...
      <v-alert        
        ...
        transition="scale-transition"
      >
        You need to connect on the Avalanche Mainnet
      </v-alert>
  </v-dialog>  
</template>
<script lang="ts">
