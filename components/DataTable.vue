<template>
  ...
  >
    <v-card-title class="text-[14px] text-[#8a8c8f]">
      <div class="flex">
        <img class="mr-[5px] icon-filter" :src="_icon" alt="" />
        <span class="text-[14px] text-[#FFFFFF]">{{ _title }}</span>
      </div>
    </v-card-title>
    <v-card-text class="pl-[32px]">
      <div
        v-if="_title == `$GEM Price`"
        class="flex text-[24px] text-[#FFFFFF] mr-[16px]"
      >
        <div class="text-[24px] text-[#B5B43E] mr-[16px]">${{ price }}</div>
      ...
      >
        <div class="text-[24px] text-[#B5B43E] mr-[16px]">
      ...
      <!-- <div v-if="_title==`Circulating Supply` || _title==`My Nodes`" class="flex justify-center">
             ...
             <div v-if="_title ==`$GEM Price` || _title ==`Market Cap` || _title==`Total Nodes`" class="text-[14px] text-[#29BB89] pt-[3px]">
          ...
          <div v-else class="flex">
             ...
             <div v-if="_title==`My $GEM Balance`" class="text-[24px] text-[#FFFFFF] mr-[16px]">{{price}}</div>
