  ...
  <div class="bg-black">
    <v-app>
      <div class="bg-[#17171b] h-full">
        ...
        <v-main class="md:py-[28px] md:mr-[28px] md:ml-[0px] h-full bg-space">
          <!-- <span class="text-[16px] text-[#FF0000]"
            ...
            https://discord.com/invite/gemnodes
          </span> -->
...
export default class Default extends Vue {
  ...
  public async NotTreasury(): Promise<void> {
    this.alertNotTreasury = true;
    await this.sleep(3000);
    this.alertNotTreasury = false;
  }
}
</script>
...
<style scoped>
  .bg-space {  
    background: url('https://gemnodes.finance/img/super_nebula.png') center left;
  }
</style>
